                                            ...
                                            protected void afterHookedMethod(MethodHookParam p) {
                                                try {
                                                    ...
                                                    if (display != null) {
                                                        ...
                                                        try { XposedHelpers.setIntField(p.thisObject, "fontSize", fontSize); } catch (Throwable t2) {}
                            ...
                            try {
                                ...
                                if (pvs != null && pvs.matches("\\d+\\.?\\d*")) {
                                    ...
                                    if (display != null) {
                                        ...
                                        int len = display.length();
                                        int fontSize = len <= 10 ? 28 : len <= 14 ? 22 : len <= 18 ? 18 : 15;
                                        try { XposedHelpers.setIntField(radioRuler, "fontSize", fontSize); } catch (Throwable t2) {}
