...
public class RadioNameHookEntry implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        if (isNSMedia) {
            ...
            // Фаза 3 отключена — нужен другой подход к долгому нажатию
        }
                                            ...
                                            protected void afterHookedMethod(MethodHookParam p) {
                                                try {
                                                    ...
                                                    if (display != null) {
                                                        ...
                                                        int fontSize = len <= 10 ? 28 : len <= 14 ? 22 : len <= 18 ? 18 : 15;
                                                        try { XposedHelpers.setObjectField(p.thisObject, "fontSize", Integer.valueOf(fontSize)); } catch (Throwable t2) {}
                            ...
                            try {
                                ...
                                if (pvs != null && pvs.matches("\\d+\\.?\\d*")) {
                                    ...
                                    if (display != null) {
                                        ...
                                        int len = display.length();
                                        int fontSize = len <= 10 ? 28 : len <= 14 ? 22 : len <= 18 ? 18 : 15;
                                        try { XposedHelpers.setObjectField(radioRuler, "fontSize", Integer.valueOf(fontSize)); } catch (Throwable t2) {}
