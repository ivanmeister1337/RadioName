...
public class StationsDatabase {
    ...
    // Масштаб шрифта для стиля "Частота + имя" в виджете — комбинированная
    // строка (частота + название) заметно шире одного имени, поэтому для
    // этого стиля текст рисуется чуть мельче оригинала.
