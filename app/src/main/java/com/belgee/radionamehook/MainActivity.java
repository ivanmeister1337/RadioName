...
public class MainActivity extends Activity {
    ...
    private void saveFontScale(float scale) {
        ...
        Toast.makeText(this, "Размер шрифта: " + (int)(scale * 100) + "% от исходного — переключи станцию на виджете чтобы увидеть",
            Toast.LENGTH_LONG).show();
    }
    ...
    private void buildUI() {
        ...
        float[] fontPresets = {0.5f, 0.65f, 0.84f, 1.0f, 1.15f, 1.26f, 1.4f};
        String[] fontLabels = {"50%", "65%", "84%", "100%", "115%", "126%", "140%"};
