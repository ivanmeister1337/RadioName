        ...
        try {
            ...
            LocationListener listener = new LocationListener() {
                ...
                @Override public void onProviderDisabled(String p) {
                    runOnUiThread(() -> gpsStatusLabel.setText("GPS выключен в системе"));
                }
            };
            ...
            try {
                if (lm.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                    lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 60000, 1000, listener);
                    requested = true;
                }
            ...
            if (!requested) {
                gpsStatusLabel.setText("Нет провайдера GPS");
                ...
                gpsStatusLabel.setText("GPS: жду координаты...");
            }
        } catch (Exception e) {
