...
public class MainActivity extends Activity {
    ...
    private void buildUI() {
        ...
        // Обновить базу из assets
        Button btnResetDb = new Button(this);
        btnResetDb.setText("🔄 Обновить базу (75 городов)");
        btnResetDb.setTextColor(0xFFAAAACC);
        btnResetDb.setOnClickListener(v -> new AlertDialog.Builder(this)
            .setTitle("Обновить базу?")
            .setMessage("Загрузит 75 городов из встроенной базы.\nВаши пользовательские имена будут сброшены.")
            .setPositiveButton("Обновить", (d, w) -> {
                try {
                    ...
                    loadSettings();
                    refreshList();
                    Toast.makeText(this, "✓ База обновлена: 75 городов", Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    Toast.makeText(this, "Ошибка: " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
            })
            .setNegativeButton("Отмена", null).show());
        root.addView(btnResetDb);
    ...
    private void showCityDialog() {
        ...
        // Добавляем опцию "Создать новый город"
        names.add("➕ Создать новый город...");
    ...
    private void showAddCityDialog() {
        ...
        regionInput.setHint("Регион (напр. Урал, Юг, Центр)");
            ...
            .setPositiveButton("Создать", (d, w) -> {
                ...
                try {
                    ...
                    if (c.moveToFirst()) {
                        ...
                        exportStationsToCache();
                        refreshList();
                        Toast.makeText(this, "✓ Город создан. Добавь станции через +", Toast.LENGTH_LONG).show();
                    }
                    c.close();
                } catch (Exception e) {
                    Toast.makeText(this, "Ошибка: " + e.getMessage(), Toast.LENGTH_LONG).show();
